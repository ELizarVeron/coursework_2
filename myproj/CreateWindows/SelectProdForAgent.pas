...
type
  ...
  public
    { Public declarations }
     ...
     var counts: array of integer;      //РЕАЛЬНЫЕ ОСТАТТКИ
...
procedure TForm18.Button1Click(Sender: TObject);      //добавление в список
begin
      ...
      begin
          ...
          begin
                 ...
                 // temp_arr.Clear;
                  ...
                  //темп аррей по ссылке передается а надо по знаечни.
                                                 begin
              ...
              for k := 0 to TProduct_Class.array_of_products.Count-1 do
               ...
               begin
                   ...
                   begin
                        ...
                        v_list[i].Add( TProduct_Class.array_of_products[k].Time_.ToString  )    ;  //время изготовления  4                                      //время на изготовление
                   end;
...
begin
 ...
 // wdApp.Visible := True;  //
  ...
  try
    ...
    wdRng.InsertAfter('Предложение для '+ agent_name + #13#10);
    ...
    wdRng.Start := wdRng.End;
    wdRng.InsertAfter(#13#10);
    wdRng.InsertAfter('Таблица 1. Товары в наличии и под заказ.'#13#10);
    wdRng.ParagraphFormat.Reset;
    wdRng.Font.Reset;
    wdRng.Font.Size := 12;
   ...
   wdRng.Font.Bold := False;
    ...
    ///Записываем шапку таблицы.
     ...
     wdTable.Cell(1, 3).Range.Text := 'В наличии';
      wdTable.Cell(1, 4).Range.Text := 'Под заказ';
     wdTable.Cell(1, 5).Range.Text := 'Время на изготовление';
 ...
 procedure TForm18.Button2Click(Sender: TObject);     //сохранить
    begin
           try
            //    save_in_doc;
...
procedure TForm18.Button3Click(Sender: TObject);      //удаление
begin
           var i:integer;
      ...
      for i := 0 to v_list.Count-1 do
        begin
                  ...
                  then
                  begin
                      label3.Caption:= (counts[i]+ StrToInt(v_list[i][1])).ToString ;  //тут меняет цифру на экране
