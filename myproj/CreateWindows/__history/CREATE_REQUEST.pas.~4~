...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.ComCtrls, Data.Win.ADODB, Agent_Class, Request_agents_class, Product_Class,Product, Main_Class , SelectProdForAgent;
       ...
       begin
         inherited;
           ...
           ado:=TADOQuery.Create(nil);
            ...
            SelectProductW:=TForm18.Create(self);
...
begin
      ...
      SelectProductW.agent_id:= id_agent;
      SelectProductW.agent_name:=name_agent;
      SelectProductW.Init;
      SelectProductW.ShowModal;
      Close;
...
begin
          //save_in_file;
         var next_id:integer;
         next_id:=SelectProductW.save_request_in_db(arr,id_agent,true);
         ...
         begin
             ...
             mc.sql_insert( ' Composition_of_req_ag  ' , arr2 );   //дробавили в состав заявки все позиции, имеющ.  на складе
             ado.Next;
         end;
