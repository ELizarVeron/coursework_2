...
procedure TForm4.Navigator_Agent_FrameLeftLabelClick(Sender: TObject);           //стрела в лево агента
begin
...
procedure TForm4.Navigator_Agent_FrameRightLabelClick(Sender: TObject);    // right Навигатор агента
begin
