  ...
  begin
      ...
      begin
        ...
        begin
          ...
          Top := (fr.Height * i) + 10;
          Tag := 1;
          TFrame9(fr).Label1.Caption :=sql_select('Company', 'Agent' , 'where ID = ' +   array_of_requests_agent[beg].ID_Agent.ToString,'',false).Fields[0].AsString; //что бы узнать имя агента по id
