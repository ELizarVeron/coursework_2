...
procedure TForm4.NavigatorFrameLeftLabelClick(Sender: TObject);           //стрела в лево агента
begin
...
procedure TForm4.NavigatorFrameRightLabelClick(Sender: TObject);    // right а
begin
  ...
  begin
    ...
    x := AgentClass.array_of_agents.Count -
      (strToInt(Navigator_Agent_Frame.Label_4.Caption) * AgentClass.on_page);  //оставшиеся фреймы для следущих страниц
